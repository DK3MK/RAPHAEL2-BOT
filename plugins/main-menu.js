...
┆┗──────────────┈ ⳹
┆♠︎ اسم البوت: *${botname}*
┆♠︎ اسم المالك: *${ownername}*
┆♠︎ نظام التشغيل: *لينكس*
┆♠︎ وقت التشغيل: *${uptime}*
┆♠︎ إجمالي المستخدمين: *${rtotalreg}*
┗┬──────────────┈ ⳹
┏┤ *معلومات المستخدم*
┆┗──────────────┈ ⳹
┆♠︎ الاسم: *${name}*
│♠︎ الحساب: *${taguser}*
│♠︎ العضوية المميزة: *${user.premium = 'true' ? '✅' : '❌'}*
┗┬──────────────┈ ⳹
┏┤ *التقويم*
┆┗──────────────┈ ⳹
┆*_بتوقيت سلطنة عُمان🇴🇲_*
┆الوقت: *${wib}*
┆التاريخ: *${date}*
┗─────────────────⬣
┆──────────────┈ ⳹
┆*اكتب* لعرض الأوامر مع الشرح /
┆ /list-ar
┆
┆*اكتب* لعرض الأوامر /
┆ /list
